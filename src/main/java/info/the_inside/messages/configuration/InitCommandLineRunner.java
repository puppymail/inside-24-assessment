package info.the_inside.messages.configuration;

import static info.the_inside.messages.configuration.AuthConfiguration.DEFAULT_SENDER_NAME;
import static info.the_inside.messages.configuration.AuthConfiguration.DEFAULT_SENDER_PASSWORD;
